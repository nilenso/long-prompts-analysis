# Annotated: google-gemini-cli-official_latest_current.txt
...
*"NEVER assume" caps prohibition; "*NEVER* talk to the user" asterisk+caps; stacking emphasis.*
...
**[FIGHTING: E_shouting]**
*"NEVER assume" caps; "VERY IMPORTANT:" caps emphasis wrapper.*
...
**[FIGHTING: A_reminders]**
*Literally titled "Final Reminder" - a reminder/nagging section.*
...
*"CRITICAL" caps; "MUST be preserved" caps deontic.*
...
- **Total paragraphs:** 43
- **Fighting paragraphs:** 6 (14.0%)
- **Non-fighting paragraphs:** 37 (86.0%)
