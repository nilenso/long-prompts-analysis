# Annotated: openai-codex-cli_na_2025-09-24.txt
...
**[FIGHTING: E_shouting]**
*"NEVER try applypatch" caps prohibition on tool name.*
...
**[FIGHTING: E_shouting]**
*"NEVER add copyright" and "NEVER output inline citations" caps prohibitions.*
...
*"may NEVER ask" caps prohibition; "You MUST do your utmost best" caps deontic in non-interactive mode description.*
...
- **Fighting paragraphs:** 4 (3.7%)
- **Non-fighting paragraphs:** 104 (96.3%)
