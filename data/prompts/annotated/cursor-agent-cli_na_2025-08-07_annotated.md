# Annotated: cursor-agent-cli_na_2025-08-07.txt
...
**[FIGHTING: E_shouting]**
*"ALWAYS use backticks" in caps for a formatting preference is over-emphasis.*
...
*"CRITICAL:", "MANDATORY:", "CONFIDENT" all in caps - stacking emphasis on search behavior.*
...
**[FIGHTING: E_shouting]**
*"CRITICAL INSTRUCTION" in caps at the start.*
...
**[FIGHTING: E_shouting]**
*"can ONLY be used", "genuinely REQUIRE" have caps emphasis on what should be neutral guidance.*
...
**[FIGHTING: E_shouting]**
*"NEVER output code" and "*EXTREMELY* important" with asterisks and caps.*
...
- **Total paragraphs:** 35
- **Fighting paragraphs:** 6 (17.1%)
- **Non-fighting paragraphs:** 29 (82.9%)
